...
class AlgoStrategy(gamelib.AlgoCore):
    ...
    def starter_strategy(self, game_state):
        ...
        #TODO Why less than 5? Let's return to this
    ...
    def stall_with_interceptors(self, game_state):
        ...
        """
        #TODO Why random? Use reactive ex. methods above
        ...
        while game_state.get_resource(MP) >= (game_state.type_cost(DEMOLISHER)[MP] + game_state.type_cost(SCOUT)[MP] + game_state.type_cost(INTERCEPTOR)[MP]) and len(best_location) > 0:
